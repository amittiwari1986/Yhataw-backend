...
// };
var options = {
    key: fs.readFileSync("STAR.yhataw.com_cert/key.pem"),
    cert: fs.readFileSync("STAR.yhataw.com_cert/cert.pem"),
ca: [
    fs.readFileSync('STAR.yhataw.com_cert/STAR.yhataw.com.ca-bundle'),
    fs.readFileSync('STAR.yhataw.com_cert/STAR.yhataw.com.ca-bundle')
] };
