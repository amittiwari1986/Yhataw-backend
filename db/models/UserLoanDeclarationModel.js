...
const connection  = require('../connect');
 ...
 const UserLoanDeclarationSchema = new Schema({
     ...
     loan_acc:{type:Schema.Types.String,unique:true,required:true},
     loan_amt:{type:Schema.Types.Number,required:true},
     loan_emi:{type:Schema.Types.Number,required:true},
     start_from:{type:Schema.Types.String,required:true},
     updated_amt:{type:Schema.Types.Number,required:true},
